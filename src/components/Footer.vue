...
<template>
  <footer class="footer items-center p-4 bg-neutral text-neutral-content mt-auto">
    <div class="items-center grid-flow-col">
      <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 34 34" class="fill-current -rotate-12">
      ...
      <p>
        {{ globalProperties.title }} {{ globalProperties.version }} - Developed by {{ globalProperties.developer }}
      </p>
    </div>
  </footer>
</template>
